...
this.accessibility = new Accessibility(this)  
  ...
  this.install = (host) => {
    ...
    this.acels.set('Move', 'Scale North', 'Shift+ArrowUp', () => { this.cursor.scale(0, 1); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale East', 'Shift+ArrowRight', () => { this.cursor.scale(1, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale South', 'Shift+ArrowDown', () => { this.cursor.scale(0, -1); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale West', 'Shift+ArrowLeft', () => { this.cursor.scale(-1, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    ...
    this.acels.set('Move', 'Scale East(Leap)', 'CmdOrCtrl+Shift+ArrowRight', () => { this.cursor.scale(this.grid.w, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale South(Leap)', 'CmdOrCtrl+Shift+ArrowDown', () => { this.cursor.scale(0, -this.grid.h); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale West(Leap)', 'CmdOrCtrl+Shift+ArrowLeft', () => { this.cursor.scale(-this.grid.w, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Goto Next Item', 'Alt+f', () => { this.cursor.gotoNextItem() })
	    this.acels.set('Move', 'Goto Previous Item', 'Alt+Shift+f', () => { this.cursor.gotoPreviousItem() } )
