...
this.accessibility = new Accessibility(this)  
  ...
  this.install = (host) => {
    ...
    this.acels.set('Move', 'Find Previous Item (Ignore Bang)', 'Alt+j', () => { this.cursor.findPreviousItem() })
	    this.acels.set('Move', 'Find Previous Item', 'Alt+Shift+j', () => { this.cursor.findPreviousItem(false) })
