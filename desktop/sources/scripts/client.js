...
this.accessibility = new Accessibility(this)  
  ...
  this.install = (host) => {
    ...
    this.acels.set('Move', 'Goto Next Item (Ignore Bang)', 'Alt+f', () => { this.cursor.gotoNextItem(false) })
	    this.acels.set('Move', 'Goto Next Item', 'Alt+Shift+f', () => { this.cursor.gotoNextItem(true) } )
    this.acels.set('Move', 'Goto Previous Item (Ignore Bang)', 'Alt+j', () => { this.cursor.gotoPreviousItem(false) })
	    this.acels.set('Move', 'Goto Previous Item', 'Alt+Shift+j', () => { this.cursor.gotoPreviousItem(true) })
