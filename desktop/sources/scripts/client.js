...
this.accessibility = new Accessibility(this)  
  ...
  this.install = (host) => {
    ...
    this.acels.set('Project', 'Find Next', 'CmdOrCtrl+J', () => { this.commander.start('findnext:') })
	    this.acels.set('Project', 'Find Previous', 'CmdOrCtrl+Shift+J', () => { this.commander.start('findprev:') })
    ...
    this.acels.set('Cursor', 'Toggle Insert Mode', 'CmdOrCtrl+I', () => { this.cursor.ins = !this.cursor.ins; this.cursor.announceInsert() })
    ...
    this.acels.set('Cursor', 'Reset', 'Escape', () => { this.toggleGuide(false); this.commander.stop(); this.clear(); this.clock.isPaused = false; this.cursor.reset() })
	    ...
	    this.acels.set('Cursor', 'Read Text Under Cursor with Screen Reader', 'Alt+Shift+d', () => { this.cursor.announcement(0, this.cursor.selection()) })
	
    this.acels.set('Move', 'Move North', 'ArrowUp', () => { this.cursor.move(0, 1); this.cursor.announcement(); })
    this.acels.set('Move', 'Move East', 'ArrowRight', () => { this.cursor.move(1, 0); this.cursor.announcement(); })
    this.acels.set('Move', 'Move South', 'ArrowDown', () => { this.cursor.move(0, -1); this.cursor.announcement(); })
    this.acels.set('Move', 'Move West', 'ArrowLeft', () => { this.cursor.move(-1, 0); this.cursor.announcement(); })
    this.acels.set('Move', 'Move North(Leap)', 'CmdOrCtrl+ArrowUp', () => { this.cursor.move(0, this.grid.h); this.cursor.announcement(2); })
    this.acels.set('Move', 'Move East(Leap)', 'CmdOrCtrl+ArrowRight', () => { this.cursor.move(this.grid.w, 0); this.cursor.announcement(2); })
    this.acels.set('Move', 'Move South(Leap)', 'CmdOrCtrl+ArrowDown', () => { this.cursor.move(0, -this.grid.h); this.cursor.announcement(2); })
    this.acels.set('Move', 'Move West(Leap)', 'CmdOrCtrl+ArrowLeft', () => { this.cursor.move(-this.grid.w, 0); this.cursor.announcement(2); })
    this.acels.set('Move', 'Scale North', 'Shift+ArrowUp', () => { this.cursor.scale(0, 1); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale East', 'Shift+ArrowRight', () => { this.cursor.scale(1, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale South', 'Shift+ArrowDown', () => { this.cursor.scale(0, -1); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale West', 'Shift+ArrowLeft', () => { this.cursor.scale(-1, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale North(Leap)', 'CmdOrCtrl+Shift+ArrowUp', () => { this.cursor.scale(0, this.grid.h); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection()); })
    this.acels.set('Move', 'Scale East(Leap)', 'CmdOrCtrl+Shift+ArrowRight', () => { this.cursor.scale(this.grid.w, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale South(Leap)', 'CmdOrCtrl+Shift+ArrowDown', () => { this.cursor.scale(0, -this.grid.h); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
    this.acels.set('Move', 'Scale West(Leap)', 'CmdOrCtrl+Shift+ArrowLeft', () => { this.cursor.scale(-this.grid.w, 0); this.cursor.announcement(this.cursor.detailLevel, this.cursor.selection(), this.cursor.x+this.cursor.w, this.cursor.y+this.cursor.h); })
	    this.acels.set('Move', 'Goto', 'Alt+L', () => { 	this.commander.start('goto:')  })
		    this.acels.set('Move', 'Goto Next Ran Item', 'Alt+K', () => { this.cursor.gotoNextRanItem() })
			    this.acels.set('Move', 'Goto Previous Ran Item', 'Alt+Shift+K', () => { this.cursor.gotoPreviousRanItem() })
	    this.acels.set('Move', 'Goto Next Item', 'Alt+j', () => { this.cursor.gotoNextItem() })
    ...
    this.acels.set('Midi', 'Next Input Device', 'CmdOrCtrl+,', () => { this.clock.setFrame(0); this.io.midi.selectNextInput(); this.accessibility.makeAnnouncement('Next Input Device: ' + this.io.midi.toInputString()) })
    this.acels.set('Midi', 'Next Output Device', 'CmdOrCtrl+.', () => { this.clock.setFrame(0); this.io.midi.selectNextOutput(); this.accessibility.makeAnnouncement('Next Output Device: ' + this.io.midi.toOutputString()) })
